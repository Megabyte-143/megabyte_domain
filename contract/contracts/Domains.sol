...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Megabyte's Name Service", "MNS")
    {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Megabyte name service", "image": "data:image/svg+xml;base64,',
    ...
    function setLink(string calldata name, string calldata record) public {
    ...
    function getLink(string calldata name) public view returns (string memory) {
        return records[name];
    }
