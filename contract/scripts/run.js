...
//     const domainOwner = await domainContract.getAddress("yash");
//     console.log("Owner of the domain yash:", domainOwner);

//     const balance = await hre.ethers.provider.getBalance(domainContract.address);
//     console.log("Contract balance:", hre.ethers.utils.formatEther(balance));

//     txn = await domainContract.setLink("LinkedIn", "https://www.linkedin.com/in/yash-garg-megabyte/");
//     await txn.wait();

//     const record = await domainContract.getLink("LinkedIn");
//     console.log(record);
